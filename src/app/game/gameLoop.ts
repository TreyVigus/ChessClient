...
function initialState(): ChessState {
    ...
    board[0][0].piece = {color: 'black', name: 6};
    board[0][1].piece = {color: 'black', name: 4};
    board[0][2].piece = {color: 'black', name: 3};
    board[0][3].piece = {color: 'black', name: 2};
    board[0][4].piece = {color: 'black', name: 1};
    board[0][5].piece = {color: 'black', name: 3};
    board[0][6].piece = {color: 'black', name: 4};
    board[0][7].piece = {color: 'black', name: 6};

    board[1][0].piece = {color: 'black', name: 5};
    board[1][1].piece = {color: 'black', name: 5};
    board[1][2].piece = {color: 'black', name: 5};
    board[1][3].piece = {color: 'black', name: 5};
    board[1][4].piece = {color: 'black', name: 5};
    board[1][5].piece = {color: 'black', name: 5};
    board[1][6].piece = {color: 'black', name: 5};
    board[1][7].piece = {color: 'black', name: 5};

    board[6][0].piece = {color: 'white', name: 5};
    board[6][1].piece = {color: 'white', name: 5};
    board[6][2].piece = {color: 'white', name: 5};
    board[6][3].piece = {color: 'white', name: 5};
    board[6][4].piece = {color: 'white', name: 5};
    board[6][5].piece = {color: 'white', name: 5};
    board[6][6].piece = {color: 'white', name: 5};
    board[6][7].piece = {color: 'white', name: 5};

    board[7][0].piece = {color: 'white', name: 6};
    board[7][1].piece = {color: 'white', name: 4};
    board[7][2].piece = {color: 'white', name: 3};
    board[7][3].piece = {color: 'white', name: 2};
    board[7][4].piece = {color: 'white', name: 1};
    board[7][5].piece = {color: 'white', name: 3};
    board[7][6].piece = {color: 'white', name: 4};
    board[7][7].piece = {color: 'white', name: 6};
