...
tg.add('non pawn move is normal move', () => {
    setPiece(state, [4, 3], {color: 1, name: 3});
    const attempedMove = {
        startPos: [4, 3],
        endPos: [0, 7]
    }
...
tg.add('white pawn single forward', () => {
    setPiece(state, [3, 7], {color: 2, name: 5});
    const attempedMove = {
        startPos: [3, 7],
        endPos: [2, 7]
    }
...
tg.add('black pawn single forward', () => {
    setPiece(state, [3, 7], {color: 1, name: 5});
    const attempedMove = {
        startPos: [3, 7],
        endPos: [4, 7]
    }
...
tg.add('white pawn double forward', () => {
    setPiece(state, [6, 7], {color: 2, name: 5});
    const attempedMove = {
        startPos: [6, 7],
        endPos: [4, 7]
    }
...
tg.add('black pawn double forward', () => {
    setPiece(state, [2, 3], {color: 1, name: 5});
    const attempedMove = {
        startPos: [2, 3],
        endPos: [4, 3]
    }
...
tg.add('white pawn normal capture 1', () => {
    setPiece(state, [2, 5], {color: 2, name: 5});
    const attempedMove = {
        startPos: [2, 5],
        endPos: [1, 6]
    }
...
tg.add('white pawn normal capture 2', () => {
    setPiece(state, [1, 1], {color: 2, name: 5});
    setPiece(state, [0, 0], {color: 1, name: 3});
    const attempedMove = {
        startPos: [1, 1],
        endPos: [0, 0]
    }
...
tg.add('black pawn normal capture 1', () => {
    setPiece(state, [4, 3], {color: 1, name: 5});
    const attempedMove = {
        startPos: [4, 3],
        endPos: [5, 4]
    }
...
tg.add('white pawn en passant 1', () => {
    setPiece(state, [3, 6], {color: 1, name: 5});
    const previousMove = {
        startPos: [1, 6],
        endPos: [3, 6]
    }
...
tg.add('white pawn en passant 2', () => {
    setPiece(state, [3, 2], {color: 1, name: 5});
    const previousMove = {
        startPos: [1, 2],
        endPos: [3, 2]
    }
    setPiece(state, [3, 1], {color: 2, name: 5});
    const attemptedMove = {
        startPos: [3, 1],
        endPos: [2, 2]
    }
...
tg.add('black pawn en passant 1', () => {
    setPiece(state, [4, 4], {color: 2, name: 5});
    const previousMove = {
        startPos: [6, 4],
        endPos: [4, 4]
    }
    setPiece(state, [4, 5], {color: 1, name: 5});
    const attemptedMove = {
        startPos: [4, 5],
        endPos: [5, 4]
    }
...
tg.add('black pawn en passant 2', () => {
    setPiece(state, [4, 2], {color: 2, name: 5});
    const previousMove = {
        startPos: [6, 2],
        endPos: [4, 2]
    }
    setPiece(state, [4, 1], {color: 1, name: 5});
    const attemptedMove = {
        startPos: [4, 1],
        endPos: [5, 2]
    }
...
tg.add('not classified as en passant if prev pawn move was capture', () => {
    ...
    setPiece(state, [2, 2], {color: 1, name: 5});
    setPiece(state, [2, 3], {color: 2, name: 5});
    const attemptedMove = {
        startPos: [2, 3],
        endPos: [1, 2]
    }
...
tg.add('not classified as en passant if prev pawn move was not from starting position 1', () => {
    ...
    setPiece(state, [2, 6], {color: 1, name: 5});
    const attemptedMove = {
        startPos: [2, 6],
        endPos: [3, 5]
    }
...
tg.add('white pawn promotion', () => {
    setPiece(state, [1,6], {color: 2, name: 5});
    const attemptedMove = {
        startPos: [1, 6],
        endPos: [0, 6]
    }
...
tg.add('black pawn promotion', () => {
    setPiece(state, [6, 0], {color: 1, name: 5});
    const attemptedMove = {
        startPos: [6, 0],
        endPos: [7, 0]
    }
...
tg.add('white queenside castle', () => {
    setPiece(state, [7, 4], {color: 2, name: 1});
    const attemptedMove = {
        startPos: [7, 4],
        endPos: [7, 2]
    }
...
tg.add('black kingside castle', () => {
    setPiece(state, [0, 4], {color: 1, name: 1});
    const attemptedMove = {
        startPos: [0, 4],
        endPos: [0, 6]
    }
...
tg.add('normal king move1', () => {
    setPiece(state, [4, 2], {color: 2, name: 1});
    const attemptedMove = {
        startPos: [4, 2],
        endPos: [1, 2]
    }
